...
function(niiet_generate_elf_bin TARGET)
    niiet_generate_binary_file(${TARGET})
...
function(niiet_generate_elf_hex TARGET)
    niiet_generate_hex_file(${TARGET})
...
function(niiet_generate_lss_file TARGET)
...
if(NOT (TARGET NIIET::Nano::FloatPrint))
    add_library(NIIET::Nano::FloatPrint INTERFACE IMPORTED)
    target_link_options(NIIET::Nano::FloatPrint INTERFACE
        $<$<C_COMPILER_ID:GNU>:-Wl,--undefined,_printf_float>
    )
endif()

if(NOT (TARGET NIIET::Nano::FloatScan))
    add_library(NIIET::Nano::FloatScan INTERFACE IMPORTED)
    target_link_options(NIIET::Nano::FloatScan INTERFACE
